        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('identities.edit', $item->id) }}" method="POST" enctype="multipart/form-data"
                          id="form_objects">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="info" id="" class="form-control" rows="10">{{ old('info', $item->info) }}</textarea>
